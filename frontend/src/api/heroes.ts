...
function mapHero(rawHero: RawHero): Superhero { return mapRawHeroToUI(rawHero); }

export async function listHeroes(page = 1, searchQuery?: string): Promise<PaginationResponse<Superhero>> {
...
function toBackendPayload(dto: CreateHeroDtoUI) { return buildBackendPayloadFromUI(dto); }
